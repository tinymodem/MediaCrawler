...
import argparse
from zhihu_utils import launch_browser, connect_existing_browser, login_by_cookies, modify_font, scroll_and_screenshot, open_comment
from tools import utils


async def process_one_url(url, output_dir, init_browser_mode="launch"):
    ...
    async with async_playwright() as p:
        ...
        if init_browser_mode == "connect":
            ...
            await scroll_and_screenshot(page, output_dir, prefix="comment")

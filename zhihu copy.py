...
async def url_to_screenshots(url, url_file_name=""):
    async with async_playwright() as p:
        ...
        # })
        # 连接到已经打开的浏览器实例
        browser = await p.chromium.connect_over_cdp("ws://localhost:9222/devtools/browser/ef5f8d38-b1a3-427e-9e5f-cb0b5f9d8715")
        ...
        # 等待一段时间以确保内容加载
        await page.wait_for_timeout(1000)  # 等待5秒
